        ...
        return (
          <div key={segment.label} className="flex items-center gap-3 text-[11px] font-mono relative group/segment">
            ...
            {segment.tooltipContent && (
              <div className="opacity-0 group-hover/segment:opacity-100 transition-opacity duration-150 absolute bottom-full left-1/2 -translate-x-1/2 sm:left-24 sm:translate-x-0 mb-1.5 z-50 pointer-events-none w-60 p-2.5 bg-slate-950 border border-slate-800 text-slate-300 shadow-xl text-[10px] leading-normal font-mono rounded-none">
