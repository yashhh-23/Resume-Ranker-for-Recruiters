...
export const XIcon = ({ className = "h-3 w-3" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const LockIcon = ({ className = "h-3.5 w-3.5", unlocked = false }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const LightningIcon = ({ className = "h-4 w-4" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const BarChartIcon = ({ className = "h-4 w-4" }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
