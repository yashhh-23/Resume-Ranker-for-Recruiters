...
import CandidateModalScores from "./candidate-modal/CandidateModalScores";
import CandidateModalReasoning from "./candidate-modal/CandidateModalReasoning";
import CandidateModalTimeline from "./candidate-modal/CandidateModalTimeline";
...
const CandidateModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex justify-end" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div
      ...
      >
        ...
        {/* 1. Header (Identity, Action Buttons, Suspicious Badge) */}
        <CandidateModalHeader
          profile={profile}
          candidate={candidate}
          result={result}
          isInAnyPool={isInAnyPool}
          onOpenPoolManager={onOpenPoolManager}
          onClose={onClose}
          isSuspiciousProfile={isSuspiciousProfile}
        />

        {/* 2. Score breakdown, waterfall math grid & cumulative index summary */}
        <CandidateModalScores
          breakdown={breakdown}
          score={result?.score}
        />
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          {/* 3. Multi-Dimensional Accordion reasoning traces */}
          <CandidateModalReasoning
            breakdown={breakdown}
            candidate={candidate}
            ...
            content = (
              <div className="space-y-6 text-slate-300 font-mono">
                <p className="text-sm text-slate-400 leading-relaxed font-mono">
                  ...
                  minimise spoofing risks and ensure authenticity in communication pipelines.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
